...
(function () {
    var PAGES = [
        ...
        { id: 'top-students',   href: 'top-students.html',   label: 'برترین دانشجویان ترم', icon: '<path d="M8 21h8M12 17v4M7 4h10v4a5 5 0 0 1-10 0V4Z"/><path d="M17 6h2a2 2 0 0 1 0 4h-.5M7 6H5a2 2 0 0 0 0 4h.5"/>' },
        { id: 'articles',       href: 'articles.html',       label: 'مقالات علمی',       icon: '<path d="M6 3h9l5 5v13a1 1 0 0 1-1 1H6a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1Z"/><path d="M9 12h6M9 16h6M9 8h2"/>' }
    ];
    ...
    function buildHeader() {
        ...
        root.innerHTML =
            '<header class="site-header">' +
                ...
                '<span class="site-header-title"><img class="site-header-logo" src="assets/logo.png" alt="آرم">گروه پزشکی پیام‌نور البرز</span>' +
                '<a class="site-header-badge" href="profile.html">ورود</a>' +
            '</header>' +
        ...
        // با لمس هر لینک صفحه، منو فوراً بسته می‌شود؛ اگر مرورگر/وب‌ویو صفحه را
        // از حافظه‌ی موقت (bfcache) برگرداند، منو دیگر باز و قفل‌شده باقی نمی‌ماند.
        drawer.querySelectorAll('.menu-drawer-item').forEach(function (link) {
    ...
    // این عملیات کاملاً اختیاری است؛ اگر مرورگر/وب‌ویو از آن پشتیبانی نکند
    // (مثلاً روی پروتکل file:// یا پیش‌نمایش داخل اپ ویرایشگر) بی‌سروصدا رد می‌شود
    // تا هیچ خطایی جابجایی بین صفحات را مختل نکند.
    function prefetchOtherPages() {
        try {
            ...
            // پیش‌بارگذاری اختیاری است؛ شکست آن نباید چیزی را خراب کند.
        }
    }
